...
class Calendar
{
    ...
    public function showCalendarTag($m, $y)
    {
        ...
        $lastDay = date("t", mktime(0, 0, 0, $month, 1, $year)); // 指定した月の最終日 //日数
        ...
        $this->html = <<< EOS
            <h1>
            <a class="btn btn-success" href="/?year={$prev_year}&month={$prev_month}" role="button">&lt;前月</a>
            {$year}年{$month}月
            <a class="btn btn-success" href="/?year={$next_year}&month={$next_month}" role="button">翌月&gt;</a>
            </h1>
